...
@pytest.mark.asyncio
async def test_handle_message_success_single_face(photo_worker, sample_event, mock_face_service, mock_single_face_service, mock_pj_querier):
    photo_worker._load_image = AsyncMock(return_value=FaceImagePayload(filename="test.jpg", content_type="image/jpeg", bytes=b"data"))
...
@pytest.mark.asyncio
async def test_handle_message_success_group_face(photo_worker, sample_event, mock_face_service, mock_photo_face_querier, mock_notification_service, mock_pj_querier):
    photo_worker._load_image = AsyncMock(return_value=FaceImagePayload(filename="test.jpg", content_type="image/jpeg", bytes=b"data"))
...
async def test_minio_retry_logic(photo_worker):
    with patch("app.worker.photo_worker.main.Bucket.get") as mock_bucket_get, \
