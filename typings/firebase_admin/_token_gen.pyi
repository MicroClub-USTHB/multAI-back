...
class _EmulatedSigner(google.auth.crypt.Signer):
    ...
    def sign(self, message): # -> Literal[b""]:
        ...
...
class _SigningProvider:
    ...
    @classmethod
    def from_credential(cls, google_cred): # -> _SigningProvider:
        ...
    
    @classmethod
    def from_iam(cls, request, google_cred, service_account): # -> _SigningProvider:
        ...
...
class TokenGenerator:
    ...
    def create_custom_token(self, uid, developer_claims=..., tenant_id=...): # -> bytes:
...
class TokenVerifier:
    ...
    def verify_id_token(self, id_token, clock_skew_seconds=...): # -> Any | Mapping[str, Any]:
        ...
    
    def verify_session_cookie(self, cookie, clock_skew_seconds=...): # -> Any | Mapping[str, Any]:
        ...
...
class _JWTVerifier:
    ...
    def verify(self, token, request, clock_skew_seconds=...): # -> Any | Mapping[str, Any]:
