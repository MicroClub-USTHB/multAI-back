...
class Client:
    ...
    def create_custom_token(self, uid, developer_claims=...): # -> bytes:
    ...
    def verify_id_token(self, id_token, check_revoked=..., clock_skew_seconds=...): # -> Any | Mapping[str, Any]:
    ...
    def get_user(self, uid): # -> UserRecord:
    ...
    def get_user_by_email(self, email): # -> UserRecord:
    ...
    def get_user_by_phone_number(self, phone_number): # -> UserRecord:
    ...
    def get_users(self, identifiers): # -> GetUsersResult:
    ...
    def list_users(self, page_token=..., max_results=...): # -> ListUsersPage:
    ...
    def create_user(self, **kwargs): # -> UserRecord:
    ...
    def update_user(self, uid, **kwargs): # -> UserRecord:
    ...
    def delete_users(self, uids): # -> DeleteUsersResult:
    ...
    def import_users(self, users, hash_alg=...): # -> UserImportResult:
