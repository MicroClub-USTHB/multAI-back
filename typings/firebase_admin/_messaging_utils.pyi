...
class AndroidConfig:
    ...
    """
    def __init__(self, collapse_key=..., priority=..., ttl=..., restricted_package_name=..., data=..., notification=..., fcm_options=..., direct_boot_ok=...) -> None:
        ...
...
class WebpushConfig:
    ...
    """
    def __init__(self, headers=..., data=..., notification=..., fcm_options=...) -> None:
        ...
...
class WebpushNotification:
    ...
    """
    def __init__(self, title=..., body=..., icon=..., actions=..., badge=..., data=..., direction=..., image=..., language=..., renotify=..., require_interaction=..., silent=..., tag=..., timestamp_millis=..., vibrate=..., custom_data=...) -> None:
        ...
...
class Aps:
    ...
    Args:
        ...
        custom_data: A dict of custom key-value pairs to be included in the Aps dictionary
            (optional).
    """
    def __init__(self, alert=..., badge=..., sound=..., content_available=..., category=..., thread_id=..., mutable_content=..., custom_data=...) -> None:
        ...
...
class ApsAlert:
    ...
    Args:
        ...
        custom_data: A dict of custom key-value pairs to be included in the ApsAlert dictionary
            (optional)
    """
    def __init__(self, title=..., subtitle=..., body=..., loc_key=..., loc_args=..., title_loc_key=..., title_loc_args=..., action_loc_key=..., launch_image=..., custom_data=...) -> None:
        ...
