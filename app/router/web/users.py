...
from app.schema.response.web.user import AdminUserSchema
from db.generated.models import StaffUser, User
...
async def create_user(
    ...
    return _to_admin_user_schema(user)
...
async def list_users(
    ...
    return [_to_admin_user_schema(user) for user in users]
