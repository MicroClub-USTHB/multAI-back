...
COMPLETE_UPLOAD_REQUEST_GROUP_PROCESSING = """-- name: complete_upload_request_group_processing \\:one
UPDATE upload_request_groups
...
FAIL_UPLOAD_REQUEST_GROUP_PROCESSING = """-- name: fail_upload_request_group_processing \\:one
UPDATE upload_request_groups
...
START_UPLOAD_REQUEST_GROUP_PROCESSING = """-- name: start_upload_request_group_processing \\:one
UPDATE upload_request_groups
...
UPDATE_UPLOAD_REQUEST_GROUP_IMPORT_PROGRESS = """-- name: update_upload_request_group_import_progress \\:one
UPDATE upload_request_groups
...
class AsyncQuerier:
    ...
    async def complete_upload_request_group_processing(self, arg: CompleteUploadRequestGroupProcessingParams) -> Optional[models.UploadRequestGroup]:
        row = (await self._conn.execute(sqlalchemy.text(COMPLETE_UPLOAD_REQUEST_GROUP_PROCESSING), {
            "p1": arg.id,
    ...
    async def fail_upload_request_group_processing(self, arg: FailUploadRequestGroupProcessingParams) -> Optional[models.UploadRequestGroup]:
        row = (await self._conn.execute(sqlalchemy.text(FAIL_UPLOAD_REQUEST_GROUP_PROCESSING), {
            "p1": arg.id,
            "p2": arg.total_photo_count,
            "p3": arg.batch_count,
            "p4": arg.processed_photo_count,
    ...
    async def start_upload_request_group_processing(self, *, id: uuid.UUID) -> Optional[models.UploadRequestGroup]:
        row = (await self._conn.execute(sqlalchemy.text(START_UPLOAD_REQUEST_GROUP_PROCESSING), {"p1": id})).first()
        if row is None:
            return None
        return models.UploadRequestGroup(
            id=row[0],
    ...
    async def update_upload_request_group_import_progress(self, arg: UpdateUploadRequestGroupImportProgressParams) -> Optional[models.UploadRequestGroup]:
        row = (await self._conn.execute(sqlalchemy.text(UPDATE_UPLOAD_REQUEST_GROUP_IMPORT_PROGRESS), {
            "p1": arg.id,
            "p2": arg.total_photo_count,
            "p3": arg.batch_count,
            "p4": arg.processed_photo_count,
